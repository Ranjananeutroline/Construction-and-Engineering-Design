        ...
        <Container fluid className='main-process'>
            <h3>Our Process</h3>
                <Row className='second-process'>
                    ...
                    <Col  className='div-col'>
                        <img src='./image/pp2.jpeg' alt='second' height={150}></img>
                        <h6>Design</h6>
                        <div className='div-paragraph'>
                    ...
                    <Col  className='div-col'>
                        <img src='./image/pp4.jpeg' alt='third' height={150}></img>
                        <h6>Develop</h6>
                        <div className='div-paragraph'>
                    ...
                    <Col  className='div-col'>
                        ...
                        <h6>Deliver</h6>
                        <div className='div-paragraph'>
                        <p>Delivering the best and quality product in the given time by the client.</p>
                        </div>
