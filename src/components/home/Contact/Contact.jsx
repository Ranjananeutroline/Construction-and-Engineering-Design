...
function Contact() {
  return (
   <>
     <div className="container" style={{backgroundColor:"rgb(231, 243, 247)",width: "95%",marginbottom:"1rem" ,borderRadius:"10px"}}>
        <h3 style={{color:"blue" ,display:"flex" ,paddingTop:"1rem",paddingLeft:"1rem" }}>Contact Us</h3>
            ...
            <div className="col-md-7"
                ...
                <form>
                    <div className="mb-1 mt-2">
                        <label htmlFor="name" style={{display:"flex" ,paddingTop:"5px"}}>Name:</label>
                    ...
                    <div className="mt-2 ">
                        ...
                        <textarea className="form-control" style={{fontSize:"14px",height:"90px" }} rows="5" id="comment" placeholder="Please describe what you need"
                            name="text"></textarea>
                    </div>
                    ...
                    <div className="row p-1">
                        <div className="col-sm-4"
                            ...
                            <div style={{float: "right",paddingRight:"14px", textAlign:"start" ,display:"flex"}}>
                                <img className="rounded-circle" src="image/recaptcha_image.jpg" height="35px" width="38px" alt="icon"/>
                            </div>
