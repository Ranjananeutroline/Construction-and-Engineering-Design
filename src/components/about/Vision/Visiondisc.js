...
const Visiondisc = () => {
  return (
    ...
    <p style={{textAlign:"justify", paddingTop:"10px" ,overflowY:"auto"}}>Our vision is to supply the best possible solutions to our customers. 
